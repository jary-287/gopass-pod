...
func (c *podService) DeletePod(ctx context.Context, in *PodInfo, opts ...client.CallOption) (*Response, error) {
...
func (h *podHandler) DeletePod(ctx context.Context, in *PodInfo, out *Response) error {
